    ...
    <>
      ...
      <div
        className={`flex md:hidden flex-col items-center absolute z-50 top-0 bottom-0 -left-[calc(100vw+1px)] w-[calc(100vw+1px)] md:w-[375px] h-screen bg-black bg-opacity-90 backdrop-blur-md border-r p-6 ${
          isOpen ? "translate-x-[calc(100vw+1px)]" : "translate-x-0"
      ...
      >
        ...
        <div className='flex flex-col flex-grow w-full justify-start items-start my-5 z-50 overflow-auto text-xl'>
          <Link
            href={"/products"}
            className='group flex justify-center align-center py-2 '
          >
            <div className='group-hover:border-b border-white'>
              All Products
            </div>
          </Link>
          <Link
            ...
            className='group flex justify-center align-center py-2 '
          >
            <div className='group-hover:border-b border-white'>Clothes</div>
          </Link>
          <Link
            href={"/products/stickers"}
            className='group flex justify-center align-center py-2 '
          >
            <div className='group-hover:border-b border-white'>Stickers</div>
          </Link>
        </div>
      </div>
    </>
